...
#------------------------------------------------------------------------------
 ...
 input            : none
 log files        : file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_2100/s2/log
 output location  : 
|--------------+------------------------------------------------+-------+--------------------|
| *mubeam*     | file:ts_warm_bore.760_2100.s2_mubeam.art.files | 51093 | in PNFS            |
| *mubeam_stn* | file:ts_warm_bore.760_2100.s2_mubeam.stn.files |       | STNTUPLE of mubeam |
|--------------+------------------------------------------------+-------+--------------------|

...
#------------------------------------------------------------------------------
 ...
 input            : file:../ts3/ts_warm_bore.760_1200.ts3_mubeam.art.files
 output location  : file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_1200/s3pbar
 log files        : file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_1200/s3pbar/log
 check_output     : 

                   file:./ts_warm_bore.760_1200.ts3_mubeam_s3_sim.check_grid_output.log  *not present - ran locally*

|---------------+------------------------------------------------------+---+-----------------------|
| *tgtstop*     | file:ts_warm_bore.760_1200.s3pbar_tgtstops.art.files |   |                       |
| *ootstop*     | file:ts_warm_bore.760_1200.s3pbar_ootstops.art.files |   |                       |
|---------------+------------------------------------------------------+---+-----------------------|
| *tgtstop_stn* | file:ts_warm_bore.760_1200.s3pbar_tgtstops.stn.files |   | STNTUPLE'd s3_tgtstop |
| *ootstop_stn* | file:ts_warm_bore.760_1200.s3pbar_ootstops.stn.files |   | STNTUPLE'd s3_tgtstop |
|---------------+------------------------------------------------------+---+-----------------------|

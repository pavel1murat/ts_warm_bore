...
input                    : none
output_location          : file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_1000/s1
log_files                : file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_1000/s1/log

|-----------------+------------------------------------------------+-------------------+--------------------|
| DSID            | catalog                                        | N(events)   INPUT |                    |
|-----------------+------------------------------------------------+-------------------+--------------------|
| *gen_50_200000* | none                                           |          10000000 |                    |
| *s1_mubeam*     | file:ts_warm_bore.760_1000.s1_mubeam.art.files |            291263 | in PNFS            |
| *s1_mubeam_stn* | file:ts_warm_bore.760_1000_s1_mubeam.stn.files |            291263 | STNTUPLE of mubeam |
|-----------------+------------------------------------------------+-------------------+--------------------|

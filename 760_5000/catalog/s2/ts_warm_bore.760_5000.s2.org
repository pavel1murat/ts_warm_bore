...
input                : file:../s1/ts_warm_bore.760_5000.s1_mubeam.art.files
log files            : file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_5000/s2/log
check_grid_output    : file:ts_warm_bore.760_5000.s1_mubeam.s2_sim.check_grid_output.log
grid_job.output_location : file:/pnfs/mu2e/scratch/users/murat/workflow/ts_warm_bore.760_5000.s1_mubeam.s2_sim/outstage/7191143/
output_location          : file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_5000/s2

|-----------------+------------------------------------------------------+-----------+----------+--------------------|
| DSID            | catalog                                              | N(events) | N(files) | comment            |
|-----------------+------------------------------------------------------+-----------+----------+--------------------|
| *s1_mubeam*     | file:../s1/ts_warm_bore.760_5000.s1_mubeam.art.files |    291263 |       50 |                    |
| *s2_mubeam*     | file:ts_warm_bore.760_5000.s2_mubeam.art.files       |     51093 |        2 |                    |
| *s2_mubeam_stn* | file:ts_warm_bore.760_5000.s2_mubeam.stn.files       |     51093 |          | STNTUPLE of mubeam |
|-----------------+------------------------------------------------------+-----------+----------+--------------------|

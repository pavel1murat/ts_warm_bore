...
|                  | input_dataset            | completed |   9800000 |             | none                                                                                                         |
|                  | grid_job.fcl_tarball     | completed |           |             | file:../tmp_fcl/ts_warm_bore.760_2000.gen_50_200000.s1_sim.fcl.tbz                                           |
|                  | grid_job.id              | completed |           |             | 31621895                                                                                                     |
...
|                  | output_location          | completed |           |             | file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_2000/s1                                                |
|                  | output_dataset.mubeam    | completed |    253035 |             | file:catalog/s1/ts_warm_bore.760_2000.s1_mubeam.art.files                                                    |
|------------------+--------------------------+-----------+-----------+-------------+--------------------------------------------------------------------------------------------------------------|
...
|                  | grid_job.id              | completed |           |             | 31751280                                                                                                     |
...
|                  | grid_job.id              | completed |           | interactive |                                                                                                              |
...
|                  | input_dataset            | completed |           |         485 | file:catalog/pbar/ts_warm_bore.760_2000.pbar_vd91.art.files                                                  |
|                  | grid_job.fcl_tarball     | completed |           |             | file:../tmp_fcl/ts_warm_bore.760_2000.pbar_vd91.ts1_sim.fcl.tbz                                              |
|                  | grid_job.id              | completed | 960000000 |    31751122 | file:/pnfs/mu2e/scratch/users/murat/workflow/ts_warm_bore.760_2000.pbar_vd91.ts1_sim/outstage/31751122/00    |
|                  | output_location          | completed |           |             | file:/mu2e/data/users/murat/datasets/ts_warm_bore/760_2000/ts1                                               |
|                  | output_dataset.mubeam    | completed |   3950407 |         480 | file:catalog/ts1/ts_warm_bore.760_2000.ts1_mubeam.art.files                                                  |
|------------------+--------------------------+-----------+-----------+-------------+--------------------------------------------------------------------------------------------------------------|
...
|------------------+--------------------------+-----------+-----------+-------------+--------------------------------------------------------------------------------------------------------------|
| ts4_sim          | catalog                  | completed |           |             | file:catalog/ts4/ts_warm_bore.760_2000.ts4.org                                                               |
|                  | input_dataset            | completed |     29797 |           2 | file:catalog/ts3/ts_warm_bore.760_2000.ts3_mubeam.art.files                                                  |
|                  | grid_job.fcl_tarball     | completed |           |             | file:../tmp_fcl/ts_warm_bore.760_2000.ts3_mubeam.ts4_sim.fcl.tbz                                             |
|                  | grid_job                 | failed    |           |    31890803 | file:/pnfs/mu2e/scratch/users/murat/workflow/ts_warm_bore.760_2000.ts3_mubeam.ts4_sim/outstage/31890803/00   |

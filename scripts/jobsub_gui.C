...
public: 
  ...
  JobSubGui(const char* Dsid, const TGWindow *p, UInt_t w, UInt_t h, int DebugLevel = 0);
  virtual ~JobSubGui();
...
//-----------------------------------------------------------------------------
JobSubGui::JobSubGui(const char* Dsid, const TGWindow *p, UInt_t w, UInt_t h, int DebugLevel) {
...
//-----------------------------------------------------------------------------
void jobsub_gui(const char* Dsid, int DebugLevel = 0) {
  JobSubGui* x = new JobSubGui(Dsid,gClient->GetRoot(),150,300,DebugLevel);
  //  return x;
}  
